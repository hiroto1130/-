...
namespace Library
{
	...
	public:
		...
		TextureData(Position position, RectSize TextureSize, Uv uv,LPDIRECT3DTEXTURE9 m_pTexture = nullptr) :  position(position), texture_size(TextureSize), uv(uv),m_pTexture(m_pTexture) {}
