...
namespace Library
{
	...
	BOOL Window::Cenerate()
	{
		...
		hWnd = CreateWindow(wndclass.lpszClassName, wndclass.lpszClassName, (WS_OVERLAPPEDWINDOW ^ WS_THICKFRAME) | WS_VISIBLE, 0, 0, window_size.width, window_size.height, NULL, NULL, wndclass.hInstance, NULL);
